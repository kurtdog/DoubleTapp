...
public class PlanetNameGeneratorEditor : Editor {
	...
	public override void OnInspectorGUI()
	{
		...
		if(GUILayout.Button("GetNames")) 
		{
			names = PlanetNameGenerator.GetNames(10);
...
public class PlanetNameGenerator : MonoBehaviour {
	...
	public static List<string> GetNames(int numNames)
	{
		List<string> names = new List<string> ();
		for(int i = 0; i < numNames; i++)
		{
			names.Add(planetNames[Random.Range(0,planetNames.Count)]);
		}
